...
import EventRegistrationScreenPresenter from "./EventRegistrationScreen";
...
class EventRegistrationScreen extends React.Component {
  ...
  render() {
    return (
      <EventRegistrationScreenPresenter {...this.state} clicked={this.clicked} navigation={this.props.navigation}></EventRegistrationScreenPresenter>
    );
  }
}
